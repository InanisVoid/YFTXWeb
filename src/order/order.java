...
public class order {
    ...
    int RoomID;
    public order(){}
    public order(int OrderID,int UserID,String Time,double DepartureLon,double DepartureLat,double DestinationLon,double DestinationLat,String Departure,String Destination, int RoomID)
    {
